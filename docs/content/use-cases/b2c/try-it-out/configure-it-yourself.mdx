...
A Email Sender must be configured for the recovery email to reach the user. The Notification Sender setup is covered in [Email Providers](/docs/next/guides/guides/notifications/email-providers) and is required regardless of which path you took.
