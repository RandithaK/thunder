...
An email provider must be configured for recovery emails to reach the user. See [Email Providers](../../guides/guides/notifications/email-providers.mdx) for setup instructions.
